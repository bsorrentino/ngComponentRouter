...
(function () {
    ...
    function routerTriggerDirective($q) {
        return {
            require: '^ngOutlet',
            priority: -1000,
            link: function link(scope, element, attr, ngOutletCtrl) {
                var promise = $q.when();
        ...
        function ngLinkDirectiveLinkFn(scope, element, attrs, ctrl) {
            ...
            function getLink(params) {
                ...
                scope.$watch(function () {
                    return router.isRouteActive(navigationInstruction);
                }, function (active) {
                    if (active) {
    ...
    angular.module('ngComponentRouter').value('$route', null). // can be overloaded with ngRouteShim
    ...
    provider('$locationHashPrefix', ['$locationProvider', $locationHashPrefixProvider]).factory('$rootRouter', ['$q', '$location', '$browser', '$rootScope', '$injector', '$routerRootComponent', '$locationHashPrefix', routerFactory]);
    ...
    function routerFactory($q, $location, $browser, $rootScope, $injector, $routerRootComponent, $locationHashPrefix) {
        ...
        var PromiseWrapper = {
            ...
            catchError: function catchError(promise, fn) {
        ...
        var RegExpWrapper = {
            create: function create(regExpStr, flags) {
        ...
        var reflector = {
            annotations: function annotations(fn) {
                //TODO: implement me
        ...
        var StringMapWrapper = {
            ...
            delete: function _delete(map, key) {
                delete map[key];
            },
        ...
        var List = Array;
        var ListWrapper = {
            toJSON: function toJSON(l) {
                return JSON.stringify(l);
            },

            clear: function clear(l) {
                l.length = 0;
            },
            ...
            push: function push(l, v) {
                return l.push(v);
            },

            forEach: function forEach(l, fn) {
                return l.forEach(fn);
            },
            ...
            map: function map(l, fn) {
                return l.map(fn);
            },

            join: function join(l, str) {
                return l.join(str);
            },
        ...
        var StringWrapper = {
            charCodeAt: function charCodeAt(s, i) {
                return s.charCodeAt(i);
            },

            equals: function equals(s1, s2) {
                return s1 === s2;
            },

            split: function split(s, re) {
                return s.split(re);
            },
        ...
        var ObservableWrapper = {
            callNext: function callNext(ob, val) {
                ob.fn(val);
            },
            callEmit: function callEmit(ob, val) {
                ob.fn(val);
            },

            subscribe: function subscribe(ob, fn) {
                ob.fn = fn;
            }
        };
        ...
        var exports = {
            ...
            OpaqueToken: function OpaqueToken() {},
            Inject: function Inject() {}
        };
        var routerRequire = function routerRequire() {
            return exports;
        };
        ...
        function normalizeRouteConfig(config, registry) {
            ...
            if (config.component) {
                if (_typeof(config.component) == 'object') {
        ...
        var Instruction = function () {
            ...
            Instruction.prototype.toLinkUrl = function () {
                return this.urlPath + this._stringifyAux() + (isPresent(this.child) ? this.child._toLinkUrl() : '') + this.toUrlQuery();
            };
        ...
        var Router = function () {
            ...
            Router.prototype.registerAuxOutlet = function (outlet) {
                ...
                var auxInstruction;
                if (isPresent(this.currentInstruction) && isPresent(auxInstruction = this.currentInstruction.auxInstruction[outletName])) {
            ...
            Router.prototype.isRouteActive = function (instruction) {
                ...
                if (isBlank(instruction.component) || isBlank(this.currentInstruction.component) || this.currentInstruction.component.routeName != instruction.component.routeName) {
                    return false;
                }
            ...
            if (isString(component)) {
                ...
                if (angular.isArray(controller.$routeConfig)) {
                    controller.$routeConfig.forEach(function (config) {
                        var _loader2 = config.loader;
                        if (isPresent(_loader2)) {
                            config = angular.extend({}, config, { loader: function loader() {
                                    return $injector.invoke(_loader2);
                                } });
                        }
